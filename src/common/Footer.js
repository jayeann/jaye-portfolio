  ...
  return (
    <div className="footer">
      ...
      <p className="footer-description">
        I’d love to hear from you! I am available to work on your projects or be
        part of your company. I'm excited to make the leap, continue refining my
        skills and bring your ideas to life.
      </p>
      <Row className="pt-4">
        <Col lg={6} xs={12}>
          <Card>
